function oneKey(obj) {
    ...
    one_key_focus.Event = function() {
      if (isAndroid()) {
        ...
        var html = $('<section class="qrcode-shadow"><div class="qrcode-wrapper"><img class="zhiwen" src="http://1251027630.cdn.myqcloud.com/1251027630/zhichi_frontend/static/version2/common/images/qrcode_focus2.png" alt="加载中"><div class="close-wrapper"><button class="close-shadow">✘</button></div><div class="qrcode-holder"><img src="' + url + '"></div></div></section>');
        $('body').append(html);
